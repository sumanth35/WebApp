...
public class CustomerProfileDAOTest {
	 ...
	 *
	 */
	private CustomerProfileDAO dataStore;

	/**
	 * Instantiates a new CustomerProfileDAOTest.
	 *
	 */
	public CustomerProfileDAOTest() {
	}

	/**
	 * Method to test CustomerProfile domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(CustomerProfileDAO dataStore) {
