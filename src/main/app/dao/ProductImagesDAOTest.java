...
public class ProductImagesDAOTest {
	 ...
	 *
	 */
	private ProductImagesDAO dataStore;

	/**
	 * Instantiates a new ProductImagesDAOTest.
	 *
	 */
	public ProductImagesDAOTest() {
	}

	/**
	 * Method to test ProductImages domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void ProductImages() {
		ProductImages instance = new ProductImages();
	 ...
	 */
	@Autowired
	public void setDataStore(ProductImagesDAO dataStore) {
