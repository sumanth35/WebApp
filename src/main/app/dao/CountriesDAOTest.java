...
public class CountriesDAOTest {
	 ...
	 *
	 */
	private CountriesDAO dataStore;

	/**
	 * Instantiates a new CountriesDAOTest.
	 *
	 */
	public CountriesDAOTest() {
	}

	/**
	 * Method to test Countries domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(CountriesDAO dataStore) {
