...
public class OrderRequestDAOTest {
	 ...
	 *
	 */
	private OrderRequestDAO dataStore;

	/**
	 * Instantiates a new OrderRequestDAOTest.
	 *
	 */
	public OrderRequestDAOTest() {
	}

	/**
	 * Method to test OrderRequest domain object.
	 *
	 */
	@Rollback(false)
	@Test
	 ...
	 */
	@Autowired
	public void setDataStore(OrderRequestDAO dataStore) {
