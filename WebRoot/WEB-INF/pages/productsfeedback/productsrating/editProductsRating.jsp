...
<html>
<head>
<title>Edit <fmt:message key="productsfeedback.title"/> <fmt:message key="productsrating.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsFeedbackProductsRating" method="POST" modelAttribute="productsrating">
