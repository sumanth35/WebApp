...
<html>
<head>
<title>Edit <fmt:message key="productimages.title"/> <fmt:message key="cartitems.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductImagesCartItemses" method="POST" modelAttribute="cartitems">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="productimages_productImageId" value="${productimages_productImageId}" >
