...
<html>
<head>
<title>Edit <fmt:message key="vendorlocations.title"/> <fmt:message key="indcities.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationsIndCities" method="POST" modelAttribute="indcities">
