...
<html>
<head>
<title>Edit <fmt:message key="vendorlocations.title"/> <fmt:message key="cartitems.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationsCartItemses" method="POST" modelAttribute="cartitems">
