...
<html>
<head>
<title>Edit <fmt:message key="vendorlocations.title"/> <fmt:message key="uscounties.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationsUsCounties" method="POST" modelAttribute="uscounties">
