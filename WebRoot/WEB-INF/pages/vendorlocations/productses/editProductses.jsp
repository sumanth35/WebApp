...
<html>
<head>
<title>Edit <fmt:message key="vendorlocations.title"/> <fmt:message key="products.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationsProductses" method="POST" modelAttribute="products">
