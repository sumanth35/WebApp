...
<html>
<head>
<title>Edit <fmt:message key="vendorlocations.title"/> <fmt:message key="indstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationsIndStates" method="POST" modelAttribute="indstates">
