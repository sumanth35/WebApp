...
<html>
<head>
<title>View <fmt:message key="vendorlocations.title"/> <fmt:message key="usstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteVendorLocationsUsStates?vendorlocations_locationId=${vendorlocations_locationId}&related_usstates_stateId=${usstates.stateId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
