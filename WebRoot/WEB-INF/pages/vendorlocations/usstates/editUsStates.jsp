...
<html>
<head>
<title>Edit <fmt:message key="vendorlocations.title"/> <fmt:message key="usstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationsUsStates" method="POST" modelAttribute="usstates">
