...
<html>
<head>
<title>Edit <fmt:message key="vendorlocations.title"/> <fmt:message key="uscities.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationsUsCities" method="POST" modelAttribute="uscities">
