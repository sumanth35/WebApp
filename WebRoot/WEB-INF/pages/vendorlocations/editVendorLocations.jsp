...
<html>
<head>
<title>Edit <fmt:message key="vendorlocations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocations" method="POST" modelAttribute="vendorlocations">
