...
<html>
<head>
<title>Edit <fmt:message key="vendorlocations.title"/> <fmt:message key="inddistrict.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationsIndDistrict" method="POST" modelAttribute="inddistrict">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="vendorlocations_locationId" value="${vendorlocations_locationId}" >
