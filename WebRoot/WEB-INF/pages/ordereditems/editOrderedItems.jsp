...
<html>
<head>
<title>Edit <fmt:message key="ordereditems.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveOrderedItems" method="POST" modelAttribute="ordereditems">
