...
<html>
<head>
<title>View <fmt:message key="orderrequest.title"/> <fmt:message key="ordereditems.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteOrderRequestOrderedItemses?orderrequest_orderRequestId=${orderrequest_orderRequestId}&related_ordereditemses_orderItemId=${ordereditems.orderItemId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
