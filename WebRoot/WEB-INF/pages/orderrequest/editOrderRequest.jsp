...
<html>
<head>
<title>Edit <fmt:message key="orderrequest.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveOrderRequest" method="POST" modelAttribute="orderrequest">
