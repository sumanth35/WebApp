...
<html>
<head>
<title>View <fmt:message key="productscategory.title"/> <fmt:message key="productsbrand.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1><fmt:message key="navigation.view"/> <fmt:message key="productsbrand.title"/></h1>
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/selectProductsCategory?categoryIdKey=${productscategory_categoryId}&"><span><img src="images/icons/back.gif" /><fmt:message key="navigation.back"/></span></a></div>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteProductsCategoryProductsBrands?productscategory_categoryId=${productscategory_categoryId}&related_productsbrands_brandId=${productsbrand.brandId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
