...
<html>
<head>
<title>Edit <fmt:message key="productscategory.title"/> <fmt:message key="productsbrand.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsCategoryProductsBrands" method="POST" modelAttribute="productsbrand">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="productscategory_categoryId" value="${productscategory_categoryId}" >
