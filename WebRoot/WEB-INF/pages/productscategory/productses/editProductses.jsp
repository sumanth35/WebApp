...
<html>
<head>
<title>Edit <fmt:message key="productscategory.title"/> <fmt:message key="products.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsCategoryProductses" method="POST" modelAttribute="products">
