...
<html>
<head>
<title>Edit <fmt:message key="vendorlocationassociations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationAssociations" method="POST" modelAttribute="vendorlocationassociations">
