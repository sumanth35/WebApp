...
<html>
<head>
<title>View <fmt:message key="vendorlocationassociations.title"/> <fmt:message key="vendorprofile.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/selectVendorLocationAssociations?vendorLocationAssociationIdKey=${vendorlocationassociations_vendorLocationAssociationId}&"><span><img src="images/icons/back.gif" /><fmt:message key="navigation.back"/></span></a></div>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteVendorLocationAssociationsVendorProfile?vendorlocationassociations_vendorLocationAssociationId=${vendorlocationassociations_vendorLocationAssociationId}&related_vendorprofile_registrationId=${vendorprofile.registrationId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
