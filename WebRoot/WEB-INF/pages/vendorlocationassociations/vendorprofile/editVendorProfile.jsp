...
<html>
<head>
<title>Edit <fmt:message key="vendorlocationassociations.title"/> <fmt:message key="vendorprofile.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorLocationAssociationsVendorProfile" method="POST" modelAttribute="vendorprofile">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="vendorlocationassociations_vendorLocationAssociationId" value="${vendorlocationassociations_vendorLocationAssociationId}" >
