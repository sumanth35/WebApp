...
<html>
<head>
<title>Edit <fmt:message key="products.title"/> <fmt:message key="productscategory.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsProductsCategory" method="POST" modelAttribute="productscategory">
