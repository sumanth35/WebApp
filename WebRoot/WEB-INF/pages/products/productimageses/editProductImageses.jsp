...
<html>
<head>
<title>Edit <fmt:message key="products.title"/> <fmt:message key="productimages.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsProductImageses" method="POST" modelAttribute="productimages">
