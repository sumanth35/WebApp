...
<html>
<head>
<title>Edit <fmt:message key="products.title"/> <fmt:message key="vendorlocations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsVendorLocations" method="POST" modelAttribute="vendorlocations">
