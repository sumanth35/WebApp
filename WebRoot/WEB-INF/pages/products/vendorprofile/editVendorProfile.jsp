...
<html>
<head>
<title>Edit <fmt:message key="products.title"/> <fmt:message key="vendorprofile.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsVendorProfile" method="POST" modelAttribute="vendorprofile">
