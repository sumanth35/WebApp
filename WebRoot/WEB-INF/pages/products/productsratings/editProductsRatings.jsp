...
<html>
<head>
<title>Edit <fmt:message key="products.title"/> <fmt:message key="productsrating.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsProductsRatings" method="POST" modelAttribute="productsrating">
