...
<html>
<head>
<title>Edit <fmt:message key="productsrating.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsRating" method="POST" modelAttribute="productsrating">
