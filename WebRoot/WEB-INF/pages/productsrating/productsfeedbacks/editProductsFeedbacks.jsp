...
<html>
<head>
<title>Edit <fmt:message key="productsrating.title"/> <fmt:message key="productsfeedback.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsRatingProductsFeedbacks" method="POST" modelAttribute="productsfeedback">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="productsrating_productRatingId" value="${productsrating_productRatingId}" >
