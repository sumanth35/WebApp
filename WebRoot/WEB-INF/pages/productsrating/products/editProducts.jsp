...
<html>
<head>
<title>Edit <fmt:message key="productsrating.title"/> <fmt:message key="products.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsRatingProducts" method="POST" modelAttribute="products">
