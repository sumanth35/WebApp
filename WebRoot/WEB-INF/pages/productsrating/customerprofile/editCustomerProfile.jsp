...
<html>
<head>
<title>Edit <fmt:message key="productsrating.title"/> <fmt:message key="customerprofile.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsRatingCustomerProfile" method="POST" modelAttribute="customerprofile">
