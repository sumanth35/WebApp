...
<html>
<head>
<title>Edit <fmt:message key="uscounties.title"/> <fmt:message key="usstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsCountiesUsStates" method="POST" modelAttribute="usstates">
