...
<html>
<head>
<title>Edit <fmt:message key="uscounties.title"/> <fmt:message key="vendorlocations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsCountiesVendorLocationses" method="POST" modelAttribute="vendorlocations">
