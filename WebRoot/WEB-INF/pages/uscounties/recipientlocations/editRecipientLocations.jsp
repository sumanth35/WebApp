...
<html>
<head>
<title>Edit <fmt:message key="uscounties.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsCountiesRecipientLocations" method="POST" modelAttribute="recipientlocation">
