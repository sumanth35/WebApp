...
<html>
<head>
<title>View <fmt:message key="userrole.title"/> <fmt:message key="vendorprofile.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteUserRoleVendorProfiles?userrole_userRoleId=${userrole_userRoleId}&related_vendorprofiles_registrationId=${vendorprofile.registrationId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
