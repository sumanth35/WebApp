...
<html>
<head>
<title>Edit <fmt:message key="cartitems.title"/> <fmt:message key="products.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCartItemsProducts" method="POST" modelAttribute="products">
