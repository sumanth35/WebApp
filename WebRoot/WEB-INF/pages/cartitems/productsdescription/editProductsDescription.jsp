...
<html>
<head>
<title>Edit <fmt:message key="cartitems.title"/> <fmt:message key="productsdescription.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCartItemsProductsDescription" method="POST" modelAttribute="productsdescription">
