...
<html>
<head>
<title>Edit <fmt:message key="cartitems.title"/> <fmt:message key="productimages.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCartItemsProductImages" method="POST" modelAttribute="productimages">
