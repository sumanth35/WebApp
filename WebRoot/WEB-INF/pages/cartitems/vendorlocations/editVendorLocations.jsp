...
<html>
<head>
<title>Edit <fmt:message key="cartitems.title"/> <fmt:message key="vendorlocations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCartItemsVendorLocations" method="POST" modelAttribute="vendorlocations">
