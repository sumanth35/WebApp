...
<html>
<head>
<title>Edit <fmt:message key="customerprofile.title"/> <fmt:message key="usstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCustomerProfileUsStates" method="POST" modelAttribute="usstates">
