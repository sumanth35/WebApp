...
<html>
<head>
<title>Edit <fmt:message key="customerprofile.title"/> <fmt:message key="uscounties.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCustomerProfileUsCounties" method="POST" modelAttribute="uscounties">
