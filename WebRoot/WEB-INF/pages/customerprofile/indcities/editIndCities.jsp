...
<html>
<head>
<title>Edit <fmt:message key="customerprofile.title"/> <fmt:message key="indcities.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCustomerProfileIndCities" method="POST" modelAttribute="indcities">
