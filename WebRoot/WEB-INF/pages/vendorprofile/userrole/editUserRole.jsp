...
<html>
<head>
<title>Edit <fmt:message key="vendorprofile.title"/> <fmt:message key="userrole.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorProfileUserRole" method="POST" modelAttribute="userrole">
