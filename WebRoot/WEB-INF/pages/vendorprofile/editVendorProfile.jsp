...
<html>
<head>
<title>Add or Edit <fmt:message key="vendorprofile.title"/></title>
</head>
<body>
<web:VendorNavBar module="VENDOR_PROFILE"></web:VendorNavBar>
...
<div id="contentarea">
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorProfile" method="POST" modelAttribute="vendorprofile">
			...
			<%--<span class="inputbutton"><input class="savebutton" id="save" type="submit" value="<fmt:message key="navigation.submit"/>"/></span>
			
			 <span class="inputbutton"><input id="submit" type="submit" value="<fmt:message key="navigation.submit" />"/></span> 
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>--%>	
		</form:form>
		<p class="buttonBox" align="center">    
			<div class="navitem">
				<a class="inputbutton" href="${pageContext.request.contextPath}/indexVendorProfile">
					<span><img src="images/icons/back.gif" /><fmt:message key="navigation.back"/></span>
					
				</a>
				
				<a class="inputbutton" href="${pageContext.request.contextPath}/indexVendorProfile">
					<span><!-- <img src="images/icons/next.jpeg" /> --><fmt:message key="navigation.continue"/></span>
					
				</a>
				
			</div>		
		</p>
		<%-- <a class="label" href="${pageContext.request.contextPath}/newVendorProfile"><span><fmt:message key="navigation.register"/></span></a> --%>
		<div class="clear">&nbsp;</div>
	</div>
	</div></div></div></div>
	</div></div></div></div>
