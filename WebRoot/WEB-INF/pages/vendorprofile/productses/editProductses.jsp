...
<html>
<head>
<title>Edit <fmt:message key="vendorprofile.title"/> <fmt:message key="products.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorProfileProductses" method="POST" modelAttribute="products">
