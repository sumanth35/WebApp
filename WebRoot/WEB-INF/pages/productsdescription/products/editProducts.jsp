...
<html>
<head>
<title>Edit <fmt:message key="productsdescription.title"/> <fmt:message key="products.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsDescriptionProducts" method="POST" modelAttribute="products">
