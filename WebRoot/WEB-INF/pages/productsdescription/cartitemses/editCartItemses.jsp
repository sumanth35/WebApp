...
<html>
<head>
<title>Edit <fmt:message key="productsdescription.title"/> <fmt:message key="cartitems.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsDescriptionCartItemses" method="POST" modelAttribute="cartitems">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="productsdescription_productDescriptionId" value="${productsdescription_productDescriptionId}" >
