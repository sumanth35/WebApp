...
<html>
<head>
<title>Edit <fmt:message key="productsdescription.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsDescription" method="POST" modelAttribute="productsdescription">
