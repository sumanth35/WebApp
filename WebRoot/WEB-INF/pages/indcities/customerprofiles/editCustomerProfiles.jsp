...
<html>
<head>
<title>Edit <fmt:message key="indcities.title"/> <fmt:message key="customerprofile.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndCitiesCustomerProfiles" method="POST" modelAttribute="customerprofile">
