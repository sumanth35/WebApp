...
<html>
<head>
<title>Edit <fmt:message key="indcities.title"/> <fmt:message key="vendorlocations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndCitiesVendorLocationses" method="POST" modelAttribute="vendorlocations">
