...
<html>
<head>
<title>Edit <fmt:message key="indcities.title"/> <fmt:message key="inddistrict.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndCitiesIndDistrict" method="POST" modelAttribute="inddistrict">
