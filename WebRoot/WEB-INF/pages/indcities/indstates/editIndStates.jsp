...
<html>
<head>
<title>Edit <fmt:message key="indcities.title"/> <fmt:message key="indstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndCitiesIndStates" method="POST" modelAttribute="indstates">
