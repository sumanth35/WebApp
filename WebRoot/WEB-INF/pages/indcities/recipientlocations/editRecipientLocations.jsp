...
<html>
<head>
<title>Edit <fmt:message key="indcities.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndCitiesRecipientLocations" method="POST" modelAttribute="recipientlocation">
