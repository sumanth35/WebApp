...
<html>
<head>
<title>Edit <fmt:message key="recipientlocation.title"/> <fmt:message key="indcities.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecipientLocationIndCities" method="POST" modelAttribute="indcities">
