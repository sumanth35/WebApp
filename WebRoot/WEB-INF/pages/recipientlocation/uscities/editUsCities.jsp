...
<html>
<head>
<title>Edit <fmt:message key="recipientlocation.title"/> <fmt:message key="uscities.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecipientLocationUsCities" method="POST" modelAttribute="uscities">
