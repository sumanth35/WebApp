...
<html>
<head>
<title>View <fmt:message key="recipientlocation.title"/> <fmt:message key="shipmentdetails.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteRecipientLocationShipmentDetailses?recipientlocation_recipientLocationId=${recipientlocation_recipientLocationId}&related_shipmentdetailses_shipmentId=${shipmentdetails.shipmentId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
