...
<html>
<head>
<title>Edit <fmt:message key="recipientlocation.title"/> <fmt:message key="shipmentdetails.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecipientLocationShipmentDetailses" method="POST" modelAttribute="shipmentdetails">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="recipientlocation_recipientLocationId" value="${recipientlocation_recipientLocationId}" >
