...
<html>
<head>
<title>Edit <fmt:message key="recipientlocation.title"/> <fmt:message key="uscounties.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecipientLocationUsCounties" method="POST" modelAttribute="uscounties">
