...
<html>
<head>
<title>Edit <fmt:message key="recipientlocation.title"/> <fmt:message key="countries.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecipientLocationCountries" method="POST" modelAttribute="countries">
