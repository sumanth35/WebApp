...
<html>
<head>
<title>Edit <fmt:message key="recipientlocation.title"/> <fmt:message key="indstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveRecipientLocationIndStates" method="POST" modelAttribute="indstates">
