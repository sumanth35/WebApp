...
<html>
<head>
<title>Edit <fmt:message key="productsbrand.title"/> <fmt:message key="productscategory.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveProductsBrandProductsCategory" method="POST" modelAttribute="productscategory">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="productsbrand_brandId" value="${productsbrand_brandId}" >
