...
<html>
<head>
<title>View <fmt:message key="productsbrand.title"/> <fmt:message key="productscategory.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/selectProductsBrand?brandIdKey=${productsbrand_brandId}&"><span><img src="images/icons/back.gif" /><fmt:message key="navigation.back"/></span></a></div>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteProductsBrandProductsCategory?productsbrand_brandId=${productsbrand_brandId}&related_productscategory_categoryId=${productscategory.categoryId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
