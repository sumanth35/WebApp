...
<html>
<head>
<title>View <fmt:message key="uscities.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
