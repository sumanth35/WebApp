...
<html>
<head>
<title>Edit <fmt:message key="uscities.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsCitiesRecipientLocations" method="POST" modelAttribute="recipientlocation">
