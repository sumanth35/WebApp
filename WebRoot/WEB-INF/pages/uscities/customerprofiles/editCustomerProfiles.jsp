...
<html>
<head>
<title>Edit <fmt:message key="uscities.title"/> <fmt:message key="customerprofile.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsCitiesCustomerProfiles" method="POST" modelAttribute="customerprofile">
