...
<html>
<head>
<title>Edit <fmt:message key="uscities.title"/> <fmt:message key="vendorlocations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsCitiesVendorLocationses" method="POST" modelAttribute="vendorlocations">
