...
<html>
<head>
<title>View <fmt:message key="uscities.title"/> <fmt:message key="vendororganizations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteUsCitiesVendorOrganizationses?uscities_cityId=${uscities_cityId}&related_vendororganizationses_organizationId=${vendororganizations.organizationId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
