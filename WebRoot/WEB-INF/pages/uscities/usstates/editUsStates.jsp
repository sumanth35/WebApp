...
<html>
<head>
<title>Edit <fmt:message key="uscities.title"/> <fmt:message key="usstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsCitiesUsStates" method="POST" modelAttribute="usstates">
