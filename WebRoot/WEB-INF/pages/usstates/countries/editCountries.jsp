...
<html>
<head>
<title>Edit <fmt:message key="usstates.title"/> <fmt:message key="countries.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsStatesCountries" method="POST" modelAttribute="countries">
