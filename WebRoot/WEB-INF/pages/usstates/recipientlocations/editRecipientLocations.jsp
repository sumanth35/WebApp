...
<html>
<head>
<title>Edit <fmt:message key="usstates.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsStatesRecipientLocations" method="POST" modelAttribute="recipientlocation">
