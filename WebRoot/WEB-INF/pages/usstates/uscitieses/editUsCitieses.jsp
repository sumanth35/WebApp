...
<html>
<head>
<title>Edit <fmt:message key="usstates.title"/> <fmt:message key="uscities.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveUsStatesUsCitieses" method="POST" modelAttribute="uscities">
