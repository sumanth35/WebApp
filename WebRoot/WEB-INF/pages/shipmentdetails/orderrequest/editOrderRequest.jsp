...
<html>
<head>
<title>Edit <fmt:message key="shipmentdetails.title"/> <fmt:message key="orderrequest.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveShipmentDetailsOrderRequest" method="POST" modelAttribute="orderrequest">
