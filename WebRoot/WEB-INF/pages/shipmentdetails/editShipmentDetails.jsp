...
<html>
<head>
<title>Edit <fmt:message key="shipmentdetails.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveShipmentDetails" method="POST" modelAttribute="shipmentdetails">
