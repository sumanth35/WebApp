...
<html>
<head>
<title>Edit <fmt:message key="shipmentdetails.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveShipmentDetailsRecipientLocation" method="POST" modelAttribute="recipientlocation">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="shipmentdetails_shipmentId" value="${shipmentdetails_shipmentId}" >
