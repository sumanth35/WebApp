...
<html>
<head>
<title>Edit <fmt:message key="orderrequeststatuses.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveOrderRequestStatuses" method="POST" modelAttribute="orderrequeststatuses">
