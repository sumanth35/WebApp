...
<html>
<head>
<title>View <fmt:message key="orderrequeststatuses.title"/> <fmt:message key="orderrequest.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/selectOrderRequestStatuses?orderRequestStatusIdKey=${orderrequeststatuses_orderRequestStatusId}&"><span><img src="images/icons/back.gif" /><fmt:message key="navigation.back"/></span></a></div>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteOrderRequestStatusesOrderRequests?orderrequeststatuses_orderRequestStatusId=${orderrequeststatuses_orderRequestStatusId}&related_orderrequests_orderRequestId=${orderrequest.orderRequestId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
