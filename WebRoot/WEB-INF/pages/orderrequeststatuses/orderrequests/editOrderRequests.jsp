...
<html>
<head>
<title>Edit <fmt:message key="orderrequeststatuses.title"/> <fmt:message key="orderrequest.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveOrderRequestStatusesOrderRequests" method="POST" modelAttribute="orderrequest">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="orderrequeststatuses_orderRequestStatusId" value="${orderrequeststatuses_orderRequestStatusId}" >
