...
<html>
<head>
<title>Edit <fmt:message key="indstates.title"/> <fmt:message key="customerprofile.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndStatesCustomerProfiles" method="POST" modelAttribute="customerprofile">
