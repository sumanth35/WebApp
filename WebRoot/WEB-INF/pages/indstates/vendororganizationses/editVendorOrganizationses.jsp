...
<html>
<head>
<title>Edit <fmt:message key="indstates.title"/> <fmt:message key="vendororganizations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndStatesVendorOrganizationses" method="POST" modelAttribute="vendororganizations">
