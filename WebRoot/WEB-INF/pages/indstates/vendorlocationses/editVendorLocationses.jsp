...
<html>
<head>
<title>Edit <fmt:message key="indstates.title"/> <fmt:message key="vendorlocations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndStatesVendorLocationses" method="POST" modelAttribute="vendorlocations">
