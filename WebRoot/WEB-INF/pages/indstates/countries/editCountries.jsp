...
<html>
<head>
<title>Edit <fmt:message key="indstates.title"/> <fmt:message key="countries.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndStatesCountries" method="POST" modelAttribute="countries">
