...
<html>
<head>
<title>Edit <fmt:message key="indstates.title"/> <fmt:message key="indcities.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndStatesIndCitieses" method="POST" modelAttribute="indcities">
