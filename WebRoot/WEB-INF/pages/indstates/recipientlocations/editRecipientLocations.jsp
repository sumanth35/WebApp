...
<html>
<head>
<title>Edit <fmt:message key="indstates.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndStatesRecipientLocations" method="POST" modelAttribute="recipientlocation">
