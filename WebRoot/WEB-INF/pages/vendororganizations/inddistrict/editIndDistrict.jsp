...
<html>
<head>
<title>Edit <fmt:message key="vendororganizations.title"/> <fmt:message key="inddistrict.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorOrganizationsIndDistrict" method="POST" modelAttribute="inddistrict">
