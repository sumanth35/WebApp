...
<html>
<head>
<title>View <fmt:message key="vendororganizations.title"/> <fmt:message key="inddistrict.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteVendorOrganizationsIndDistrict?vendororganizations_organizationId=${vendororganizations_organizationId}&related_inddistrict_districtId=${inddistrict.districtId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
