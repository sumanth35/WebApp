...
<html>
<head>
<title>Edit <fmt:message key="vendororganizations.title"/> <fmt:message key="indstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorOrganizationsIndStates" method="POST" modelAttribute="indstates">
