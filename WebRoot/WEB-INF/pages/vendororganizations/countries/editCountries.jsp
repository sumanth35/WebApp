...
<html>
<head>
<title>Edit <fmt:message key="vendororganizations.title"/> <fmt:message key="countries.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorOrganizationsCountries" method="POST" modelAttribute="countries">
