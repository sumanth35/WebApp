...
<html>
<head>
<title>View <fmt:message key="vendororganizations.title"/> <fmt:message key="countries.title"/></title>
</head>
<body>
<div id="contentarea">      
