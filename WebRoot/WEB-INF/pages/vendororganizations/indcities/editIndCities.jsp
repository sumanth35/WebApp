...
<html>
<head>
<title>Edit <fmt:message key="vendororganizations.title"/> <fmt:message key="indcities.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveVendorOrganizationsIndCities" method="POST" modelAttribute="indcities">
