...
<html>
<head>
<title>Edit <fmt:message key="inddistrict.title"/> <fmt:message key="indstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndDistrictIndStates" method="POST" modelAttribute="indstates">
