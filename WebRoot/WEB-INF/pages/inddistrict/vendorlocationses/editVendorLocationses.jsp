...
<html>
<head>
<title>Edit <fmt:message key="inddistrict.title"/> <fmt:message key="vendorlocations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndDistrictVendorLocationses" method="POST" modelAttribute="vendorlocations">
