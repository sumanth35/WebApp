...
<html>
<head>
<title>View <fmt:message key="inddistrict.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteIndDistrictRecipientLocations?inddistrict_districtId=${inddistrict_districtId}&related_recipientlocations_recipientLocationId=${recipientlocation.recipientLocationId}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
