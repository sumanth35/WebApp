...
<html>
<head>
<title>Edit <fmt:message key="inddistrict.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndDistrictRecipientLocations" method="POST" modelAttribute="recipientlocation">
