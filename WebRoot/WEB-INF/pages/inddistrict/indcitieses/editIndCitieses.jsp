...
<html>
<head>
<title>Edit <fmt:message key="inddistrict.title"/> <fmt:message key="indcities.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveIndDistrictIndCitieses" method="POST" modelAttribute="indcities">
