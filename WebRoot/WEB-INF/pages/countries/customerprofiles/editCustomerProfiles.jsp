...
<html>
<head>
<title>Edit <fmt:message key="countries.title"/> <fmt:message key="customerprofile.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCountriesCustomerProfiles" method="POST" modelAttribute="customerprofile">
