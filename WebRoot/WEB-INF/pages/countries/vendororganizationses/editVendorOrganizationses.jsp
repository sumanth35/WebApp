...
<html>
<head>
<title>Edit <fmt:message key="countries.title"/> <fmt:message key="vendororganizations.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCountriesVendorOrganizationses" method="POST" modelAttribute="vendororganizations">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="countries_countryId" value="${countries_countryId}" >
