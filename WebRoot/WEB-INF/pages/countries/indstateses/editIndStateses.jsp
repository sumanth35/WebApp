...
<html>
<head>
<title>Edit <fmt:message key="countries.title"/> <fmt:message key="indstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCountriesIndStateses" method="POST" modelAttribute="indstates">
