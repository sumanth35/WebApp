...
<html>
<head>
<title>Edit <fmt:message key="countries.title"/> <fmt:message key="recipientlocation.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCountriesRecipientLocations" method="POST" modelAttribute="recipientlocation">
