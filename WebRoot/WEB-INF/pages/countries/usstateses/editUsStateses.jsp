...
<html>
<head>
<title>Edit <fmt:message key="countries.title"/> <fmt:message key="usstates.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveCountriesUsStateses" method="POST" modelAttribute="usstates">
